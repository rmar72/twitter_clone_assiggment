...
if (cluster.isMaster) {
    ...
    // POST /tweet endpoint
    // app.post('/tweet', tweetLimiter, async (req, res) => { // uncomment for rate limiting
    ...
    // app.get('/trending-hashtags', trendingHashtagsLimiter, async (req, res) => { // uncomment for rate limiting
